<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/PinnaclePlus_master.Master" CodeBehind="export_batches.aspx.vb" Inherits=".export_batches" %>
    ...
    <div class="top_cap">
            ...
            <table style="width :60%;" >
                <tr>
                    ...
                    <td>
                        Step 2:</td>
                    <td>
                        <asp:LinkButton ID="lbExporttoOnfleet" runat="server">Export to Onfleet</asp:LinkButton>
                        
                    </td>
                    <td>Step 3:</td>
                    <td>
                        <asp:LinkButton ID="lbGetAssignment" runat="server">Sync With Onfleet</asp:LinkButton>
                    </td>
                    <td>
                        Step 4:</td>
                    <td>
        ...
        <asp:GridView id="gvData" runat="server" CssClass="AppLabel" Width="100%" AutoGenerateColumns="False" DataKeyNames="MO_ID">
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="OF Status" HeaderStyle-Width="10px" >
