...
Public Class TaskSheetReport1
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_P_Add_Ticket() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedTaskSheetReport1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TaskSheetReport1 = New TaskSheetReport1()
        rpt.Site = Me.Site
        Return rpt
    End Function
